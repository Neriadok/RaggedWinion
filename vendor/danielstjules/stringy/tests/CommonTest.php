...
abstract class CommonTest extends PHPUnit_Framework_TestCase {
	...
	public function slugifyProvider() {
		return array (
				...
				array (
						'podekhal-k-podezdu-moego-doma',
						'подъехал к подъезду моего дома' 
				),
				array (
						'foo:bar:baz',
						'Foo bar baz',
				...
				array (
						...
						'A_string with_underscores',
						'_' 
				),
				array (
						'a_string_with_dashes',
						'A string-with-dashes',
						'_' 
				),
				array (
	...
	public function removeLeftProvider() {
		return array (
				...
				array (
						'oo bar',
						'foo bar',
						Stringy::create ( 'foo bar' )->first ( 1 ),
						'UTF-8' 
				),
				array (
						'oo bar',
						'foo bar',
						Stringy::create ( 'foo bar' )->at ( 0 ),
						'UTF-8' 
				),
				array (
						'fòô bàř',
	...
	public function removeRightProvider() {
		return array (
				...
				array (
						'foo ba',
						'foo bar',
						Stringy::create ( 'foo bar' )->last ( 1 ),
						'UTF-8' 
				),
				array (
						'foo ba',
						'foo bar',
						Stringy::create ( 'foo bar' )->at ( 6 ),
						'UTF-8' 
				),
				array (
						'fòô bàř',
