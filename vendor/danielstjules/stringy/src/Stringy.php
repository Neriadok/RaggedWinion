...
class Stringy implements \Countable, \IteratorAggregate, \ArrayAccess {
	 ...
	 * when called.
	 * This maintains the immutability of Stringy objects.
	 *
	 * @param mixed $offset
	...
	public function camelize() {
		...
		$camelCase = preg_replace_callback ( '/[-_\s]+(.)?/u', function ($match) use($encoding) {
	...
	public function slugify($replacement = '-') {
		...
		return $stringy->toLowerCase ()->applyDelimiter ( $replacement )->removeLeft ( $replacement )->removeRight ( $replacement );
	}
	 ...
	 * An alias for PHP's trim() function.
	 *
