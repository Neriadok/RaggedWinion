...
class AnnotationClassLoaderTest extends AbstractAnnotationLoaderTest {
	...
	public function testLoad($className, $routeDatas = array(), $methodArgs = array()) {
		...
		$this->reader->expects ( $this->once () )->method ( 'getMethodAnnotations' )->will ( $this->returnValue ( array (
				$this->getAnnotatedRoute ( $routeDatas ) 
		) ) );
	...
	public function testClassRouteLoad() {
		$classRouteDatas = array (
				'path' => '/classRoutePrefix' 
		);
		...
		$this->reader->expects ( $this->once () )->method ( 'getClassAnnotation' )->will ( $this->returnValue ( $this->getAnnotatedRoute ( $classRouteDatas ) ) );
