...
class Swift_Signers_DKIMSignerTest extends \SwiftMailerTestCase {
	...
	private function _createHeaders() {
		...
		$headers->shouldReceive ( 'listAll' )->zeroOrMoreTimes ()->andReturn ( array (
				'From',
				'To',
				'Date',
				'Subject' 
		...
		$headers->shouldReceive ( 'getAll' )->zeroOrMoreTimes ()->with ( 'Subject' )->andReturn ( array (
		...
		$headers->shouldReceive ( 'getAll' )->zeroOrMoreTimes ()->with ( 'DKIM-Signature' )->andReturn ( array (
