...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends \SwiftMailerTestCase {
	...
	public function testSuccessfulAuthentication() {
		...
		$agent->shouldReceive ( 'executeCommand' )->once ()->with ( 'AUTH NTLM ' . base64_encode ( $this->_invokePrivateMethod ( 'createMessage1', $ntlm ) ) . "\r\n", array (
				334 
		...
		$agent->shouldReceive ( 'executeCommand' )->once ()->with ( base64_encode ( $this->_invokePrivateMethod ( 'createMessage3', $ntlm, array (
				$domain,
				$username,
