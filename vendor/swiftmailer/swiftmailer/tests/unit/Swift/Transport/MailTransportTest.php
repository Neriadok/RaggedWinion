...
class Swift_Transport_MailTransportTest extends \SwiftMailerTestCase {
	...
	public function testTransportUsesToFieldBodyInSending() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( "Foo <foo@bar>", \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any () );
	...
	public function testTransportUsesSubjectFieldBodyInSending() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), "Thing", \Mockery::any (), \Mockery::any (), \Mockery::any () );
	...
	public function testTransportUsesBodyOfMessage() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), \Mockery::any (), "This body", \Mockery::any (), \Mockery::any () );
	...
	public function testTransportUsesHeadersFromMessage() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), \Mockery::any (), \Mockery::any (), "Subject: Stuff" . PHP_EOL, \Mockery::any () );
	...
	public function testTransportReturnsCountOfAllRecipientsIfInvokerReturnsTrue() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any () )->andReturn ( true );
	...
	public function testTransportReturnsZeroIfInvokerReturnsFalse() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any () )->andReturn ( false );
	...
	public function testToHeaderIsRemovedFromHeaderSetDuringSending() {
		...
		$invoker->shouldReceive ( 'mail' )->once ()->with ( \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any (), \Mockery::any () );
