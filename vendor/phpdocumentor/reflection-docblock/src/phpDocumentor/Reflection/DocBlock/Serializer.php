...
class Serializer {
	 ...
	 *
	 * @param int $indent
	 *        	The number of times the indent string is
	 *        	repeated.
	 ...
	 *        	The max length of a line or NULL to
	 ...
	 *        	The string to indent comments with.
	 *        	
	 ...
	 *
	 * @param int|null $lineLength
	 *        	The length of each line. NULL to disable line
	 *        	wrapping altogether.
	 *        	
	 * @return $this This serializer object.
	 */
