...
class Tag implements \Reflector {
	 ...
	 */
	final public static function createInstance($tag_line, DocBlock $docblock = null, Location $location = null) {
		...
		if ('' !== $tag && class_exists ( $handler, true ) && is_subclass_of ( $handler, __CLASS__ ) && ! strpos ( $tag, '\\' )) // Accept no slash, and 1st slash at offset 0.
{
	 ...
	 *
	 * @param DocBlock $docblock
	 *        	The new docblock this tag belongs to. Setting
	 ...
	 *      
	 * @return void @codeCoverageIgnore Not yet implemented
	 */
