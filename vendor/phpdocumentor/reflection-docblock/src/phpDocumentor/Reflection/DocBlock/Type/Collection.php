...
class Collection extends \ArrayObject {
	 ...
	 *
	 * @param string[] $types
	 *        	Array containing a list of types to add to this
	 *        	container.
	 * @param Context $location
	 *        	The current invoking location.
	 */
	 ...
	 *
	 * @param string $type
	 *        	A 'Type' as defined in the phpDocumentor
	 *        	documentation.
	 *        	
	 ...
	 *
	 * @param string $type
	 *        	A relative or absolute type as defined in the
