...
class Context {
	 ...
	 *        	The namespace where this DocBlock
	 *        	resides in.
	 * @param array $namespace_aliases
	 *        	List of namespace aliases => Fully
	 *        	Qualified Namespace.
	 * @param string $lsen
	 *        	Name of the structural element, within
	 *        	the namespace.
	 */
	 ...
	 *
	 * @param string $alias
	 *        	The alias name (the part after "as", or the last
	 *        	part of the Fully Qualified Namespace Name) to add.
	 * @param string $fqnn
	 *        	The Fully Qualified Namespace Name for this alias.
