...
class DocBlock implements \Reflector {
	 ...
	 *        	A docblock comment (including
	 *        	asterisks) or reflector supporting the getDocComment method.
	 * @param Context $context
	 *        	The context in which the DocBlock
	 *        	occurs.
	 * @param Location $location
	 *        	The location within the file that this
	 *        	DocBlock occurs in.
	 *        	
	 ...
	 *        	The new text portion of the doc block.
	 *        	
	 ...
	 *       implement it.
	 *      
	 * @return string @codeCoverageIgnore Not yet implemented
	 */
