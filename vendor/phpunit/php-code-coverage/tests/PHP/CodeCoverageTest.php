...
class PHP_CodeCoverageTest extends PHP_CodeCoverage_TestCase {
	...
	public function testGetLinesToBeIgnored3() {
		$this->assertEquals ( array (
				...
				19,
				20 
		), $this->getLinesToBeIgnored ()->invoke ( $this->coverage, TEST_FILES_PATH . 'source_with_class_and_anonymous_function.php' ) );
	}
	...
	public function testGetLinesToBeIgnoredOneLineAnnotations() {
		$this->assertEquals ( array (
				...
				34,
				37 
		), $this->getLinesToBeIgnored ()->invoke ( $this->coverage, TEST_FILES_PATH . 'source_with_oneline_annotations.php' ) );
	}
